		...
		try
		{
			if (is_array($ssl))
			{
				...
				$this->_connection->ssl_set(
					isset($ssl['client_key_path']) ? $ssl['client_key_path'] : null,
					isset($ssl['client_cert_path']) ? $ssl['client_cert_path'] : null,
					isset($ssl['ca_cert_path']) ? $ssl['ca_cert_path'] : null,
					isset($ssl['ca_dir_path']) ? $ssl['ca_dir_path'] : null,
